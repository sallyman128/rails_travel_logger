...
class FlightsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create flight' do
    assert_difference('Flight.count') do
      post flights_url,
           params: { flight: { arrival_time: @flight.arrival_time, departure_time: @flight.departure_time,
                               destination: @flight.destination, flight_number: @flight.flight_number, origin: @flight.origin } }
    end
